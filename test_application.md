# Routigo — Security & Production Readiness Test Plan
...
**Expected:** Only `https://routigo.vercel.app` (and optionally `http://localhost:5173` for dev). No `*` wildcard.
...
**Expected:** Only `https://routigo.vercel.app/**` and `http://localhost:5173/**` listed.
...
**Status:** N/A — Routigo has no file upload or storage bucket functionality.

### #20 — File Upload Validation (N/A)
**Status:** N/A — Routigo has no file upload functionality.

### #21 — Webhook Signature Verification (N/A)
**Status:** N/A — Routigo has no payment webhooks.

### #22 — Email Provider SPF/DKIM (N/A)
**Status:** N/A — Routigo uses Supabase's built-in email service for auth emails.
